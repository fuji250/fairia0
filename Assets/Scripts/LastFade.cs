...
/// </summary>
public class LastFade : MonoBehaviour
{

	#region Singleton

	private static LastFade instance;

	public static LastFade Instance
	{
		get
		{
			if (instance == null)
			{
				instance = (LastFade)FindObjectOfType(typeof(LastFade));

				if (instance == null)
				{
					Debug.LogError(typeof(LastFade) + "is nothing");
				}
			}
